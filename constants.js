...
export const ENVIRONMENT = {
  ...
  troughCaptureRadiusDeg: 24,
  troughCaptureVKtPerStrength: 14,
  troughCaptureUKtPerStrength: 10,
...
export const SUBTROPICAL = {
  ...
  minSst: 22.5,          // subtropical formation tolerates cooler water
  maxShear: 26,
  minLat: 22,
  ...
  // storm.
  minGenesisLon: -98,
  // Longitude alone can't correctly separate the basins near the
  // The simple longitude gate above breaks down near Panama/Costa Rica
  // specifically — the isthmus curves such that its Pacific-facing south
  // coast sits as far east as roughly -84 to -77, well inside the
  // longitude gate's "Atlantic" side. A storm genuinely forming south of
  // the isthmus (below ~9.5N, between these longitudes) is Pacific
  // territory regardless of the general -98 boundary. See
  // isEasternPacificPosition() in simulation.js.
  panamaCurveLatMax: 9.5,
  panamaCurveLonMin: -84,
  panamaCurveLonMax: -77,
};
